                ...
                <Card className="border-none bg-secondary/20 shadow-2xl backdrop-blur-xl">
                    <CardHeader className="text-center space-y-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <CardDescription>Join telyourstory and start your journey.</CardDescription>
                        </div>
                    </CardHeader>
                    <CardContent>
                    ...
                    <CardFooter className="justify-center text-sm text-muted-foreground">
                        Already have an account? <Link href="/login" className="text-primary hover:underline ml-1 font-medium">Log in</Link>
                    </CardFooter>
                </Card>
            </motion.div>
        </div>
